      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="py-3 d-flex justify-content-between">
            <h4 class="mb-0"> STANDARD TEMPLATES </h4>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12 p-0">
          <table class="table table-striped" id="f_table">
            <tr>
              ...
              <th class="p-1 py-2 " > Number of Countries</th>
              <th class="p-1 py-2 " > Number of Offices </th>
              <th class="p-1 py-2 " > Created </th>
            ...
            <tr>
              ...
              <td class="p-1 py-2 ">
                <button type="button" class="btn my_btn primary_style fs mb-1"><i class="fa fa-search"></i></button><br>
